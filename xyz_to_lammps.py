...
'''set head directory'''
head_dir = r'/home/mk8347/scratch/molecule_clusters/battery_10'
...
for run_num, size, temp, crystal, gap_rate in zip(run_nums, size_list, temp_list, crystal_list, gap_list):
