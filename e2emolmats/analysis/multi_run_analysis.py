...
"""classifier outputs"""
plot_classifier_pies(results_df, 'max_sphere_radius', 'defect_rate', extra_axes=['temperature'], extra_axes_values=[temperature])
#
# "alignment"
# cluster_property_heatmap(results_df, 'global_Ip_alignment', 'max_sphere_radius', 'defect_rate',
#                          extra_axes=['temperature'], extra_axes_values=[temperature], take_mean=True, norm_against_zero_y=False)
#
...
#                          'max_sphere_radius',
#                          'defect_rate',
#                          extra_axes=['temperature'], extra_axes_values=[temperature],
