...
batch_config = {
    ...
    'temperature': [350, 365, 380, 390, 400, 410, 420],  # Kelvin
    ...
    'run_time': [1e7, 2e7],  # sampling time in femtoseconds
    ...
    'run_name': 'acridine_melt_interface10',
    'min_lattice_length': [30, 40, 50],
