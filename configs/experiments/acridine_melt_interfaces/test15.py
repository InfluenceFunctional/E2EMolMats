...
batch_config = {
    ...
    'temperature': [370, 380, 385, 390, 395, 400, 405, 410, 420, 430],  # Kelvin
    'structure_identifier': ['acridine/Form6', 'acridine/Form7', 'acridine/Form8', 'acridine/Form9'],  # 2 , 3, 4, 6, 7, 8, 9
    'defect_rate': [0],
    ...
    'run_name': 'acridine_melt_interface14',
