...
"""we are re-doing test 2, more cheaply, since it was so small, it didn't properly melt in many cases"""
import yaml
...
batch_config = {
    ...
    'temperature': [350, 370, 380, 400],  # Kelvin
    ...
    'run_name': 'acridine_melt_interface4',
