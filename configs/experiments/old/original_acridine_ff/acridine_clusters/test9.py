...
batch_config = {
    ...
    'max_sphere_radius': [5, 10, 15, 20, 25, 30, 35],  # if carving a finite cluster from a bulk structure, the radius of the sphere
