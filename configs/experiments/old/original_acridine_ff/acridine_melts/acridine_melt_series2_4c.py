...
batch_config = {
    ...
    'gap_rate': [0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25, 0.275, 0.3],  # fraction of molecule sites to be left vacant
    'scramble_rate': [0],  # fraction of molecules to be randomly rotated
    'seed': [4, 5, 6, 7, 8],  # integers greater than zero
    ...
    'run_time': int(2e7),  # sampling time in femtoseconds
    'box_type': 'p',
    ...
    'run_name': 'acridine_melt_series2_4c',
