...
batch_config = {
    ...
    'min_inter_cluster_distance': 30,  # sets periodic box size in cluster simulations, 0 or None if unused
    'bulk_crystal': True,  # if true, periodic structure
    'machine': 'cluster',  # 'local' or 'cluster' have different associated paths
    'run_name': 'acridine_cp2',
    ...
    'prep_bulk_melt': [False, True],  # prepare a bulk melted structure - npt equil, nvt melt, nvt cool, npt equil
