...
batch_config = {
    ...
    'temperature': [100, 700],  # Kelvin - the temperature at which to carry out primary sampling
    ...
    'pressure_direction': 'iso',  # iso, x, y, or z for npt pressure directionality. Also the interface axis in interfaces. 'iso' invalid for melts.
    'ramp_temperature': False,  # linearly ramp temperature in main sampling run from 0 to ramp_temperature
    'init_temperature': 0,
    ...
    'moving_interface_protocol': False,
    # sample for run_time, then increase temperature by temp_step and hold for step_time
