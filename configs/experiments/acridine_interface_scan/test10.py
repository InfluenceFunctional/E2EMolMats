...
batch_config = {
    ...
    'damping': [str(1000.0)],  # for LAMMPS Langevin dynamics
    ...
    'run_name': 'acridine_interface_scan10',
    'min_lattice_length': [40, 50],
    ...
    'moving_interface_time': 1e7,
    'equil_time': 1e6,  # equilibration time, for melt preparation steps
