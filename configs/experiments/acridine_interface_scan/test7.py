...
batch_config = {
    ...
    'damping': [str(1.0), str(10.0), str(100.0), str(500.0), str(1000.0), str(5000.0), str(10000.0), str(50000.0)],  # for LAMMPS Langevin dynamics
    ...
    'integrator': ['langevin'],  # nosehoover, npt, nvt, langevin
    ...
    'init_temperature': 200,  # for bulk ramps only
    ...
    'run_name': 'acridine_interface_scan7',
    ...
    'moving_interface_num_steps': 11,
    'moving_interface_step': 5,
    'moving_interface_time': 1e6,
    'equil_time': 2.5e5,  # equilibration time, for melt preparation steps
