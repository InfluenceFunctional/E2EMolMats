...
batch_config = {
    ...
    'min_inter_cluster_distance': 20,  # sets periodic box size in cluster simulations
    'bulk_crystal': True,  # if true, periodic structure
    'machine': 'cluster',  # 'local' or 'cluster' have different associated paths
    'run_name': 'new_cluster_melt1',
    'min_lattice_length': 20,  # for periodic bulk simulations. Supercell a x b x c a,b,c will be set to approximately at least this edge length.
