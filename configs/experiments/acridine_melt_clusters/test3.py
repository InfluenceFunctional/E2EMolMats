...
batch_config = {
    ...
    'temperature': [330, 360, 390],  # Kelvin
    ...
    'run_time': [5e6, 1e7],  # sampling time in femtoseconds
    ...
    'min_inter_cluster_distance': [20, 40],  # 40,  # sets periodic box size in cluster simulations, 0 or None if unused
    'bulk_crystal': True,  # if true, periodic structure
    'machine': 'cluster',  # 'local' or 'cluster' have different associated paths
    'run_name': 'acridine_cluster3',
