...
batch_config = {
    ...
    'max_sphere_radius': [10, 20],  # if carving a finite cluster from a bulk structure, the radius of the sphere
    'invert_defects': [False, True],

    # static items - DO NOT SET AS LIST
    'run_time': 1e5,  # sampling time in femtoseconds
    ...
    'min_inter_cluster_distance': 20,  # 40,  # sets periodic box size in cluster simulations, 0 or None if unused
