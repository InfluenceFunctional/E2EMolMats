...
batch_config = {
    ...
    'temperature': [320, 330, 340],  # Kelvin
    ...
    'max_sphere_radius': [10, 15, 20, 25, 30, 35],  # if carving a finite cluster from a bulk structure, the radius of the sphere
