...
# results_df = pd.concat([results_df, pd.read_pickle('defect_clusters_3/results_df')])
# results_df = pd.concat([results_df, pd.read_pickle('defect_clusters_4/results_df')])
#
# cluster_property_heatmap(results_df, 'global_Ip_alignment', 'max_sphere_radius', 'defect_rate',
#                          extra_axes=['temperature'], extra_axes_values=[250], take_mean=True)
#
...
results_df = pd.concat([results_df, pd.read_pickle('defect_clusters_3/results_df2')])
results_df = pd.concat([results_df, pd.read_pickle('defect_clusters_4/results_df2')])
