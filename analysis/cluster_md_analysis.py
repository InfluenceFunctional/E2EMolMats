...
params = {
    ...
    'battery_path': r'C:\Users\mikem\crystals\clusters\cluster_structures\battery_11/',
    ...
    if (run_dir != 'common') and \
        ...
        if 'oom' in text:  # run crashed
            ...
            new_row = {"run_num": run_dir,
                       ...
                       "Ip_overlap_trajectory": [Ip_overlap_trajectory],
                       "ref_Ip_trajectory": [ref_Ip_trajectory],
                       "ref_Ip_overlaps_trajectory": [ref_Ip_overlap_trajectory],
                       }
...
if "rdf_drift" in results_df.columns():
    ...
    fig.update_layout(yaxis=dict(
        tickmode='array',
        tickvals=np.arange(len(gap_rates)),
        ticktext=gap_rates
    ))
